          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="{{ route('add_user') }}" class="btn btn-info">Thêm</a> | 
                ...
                <!-- SEARCH FORM -->
                      ...
                      <select class="form-control" id="user_status">
                        ...
                        <option value="1" style="font-weight: bold!important">Đang hoạt động</option>
              	...
              	<table class="table table-hover">
                      ...
                      <th scope="col"></th>
                          ...
                          <th scope="row"><input class="form-check-input" type="checkbox" value="{{ $user->id }}" id="{{ $user->id }}"></th>
                          	...
                          	<a href="{{ route('edit_user', $user->id) }}"><i class="fas fa-edit"></i></a> |
